...
class CR5ReachVisualEnv(gym.Env):
    ...
    def __init__(self, is_render=False, is_good_view=False):
        ...
        self.z_low_obs = 0
        self.z_high_obs = 0.45

        self.x_low_action = -0.2
        self.x_high_action = 0.6
        self.y_low_action = -0.3
        self.y_high_action = 0.3
        self.z_low_action = -0.3
        ...
        # ]
        self.init_joint_positions = [0, 0.81, -2.64, 1.57, 1.53, 0]
    ...
    def reset(self):
        ...
        self.cr5_id = p.loadURDF("../URDF_model/urdf/cr5_robot.urdf",
                                 useFixedBase=True)
        # self.cr5_id = p.loadURDF(os.path.join(self.urdf_root_path, "kuka_iiwa/model.urdf"),
        #                            useFixedBase=True)
...
if __name__ == '__main__':
    ...
    env = CR5ReachVisualEnv(is_render=True)
